...
import io.github.alidee1410.common.items.ReuseableItem;
...
public class ItemInit {
	...
	public static final RegistryObject<Item> MORTAR_AND_PESTLE = ITEMS.register("mortar_and_pestle",
			() -> new ReuseableItem(42, new ReuseableItem.Properties().group(AlisBeanMod.BEAN_MOD_TAB)));

	// Food
	public static final RegistryObject<Item> TOMATO = ITEMS.register("tomato",
			() -> new Item(new Item.Properties().group(AlisBeanMod.BEAN_MOD_TAB).food(FoodInit.TOMATO)));
	
	public static final RegistryObject<Item> CORN = ITEMS.register("corn",
			() -> new Item(new Item.Properties().group(AlisBeanMod.BEAN_MOD_TAB).food(FoodInit.CORN)));
	
	public static final RegistryObject<Item> WILD_HARICOT_BEANS = ITEMS.register("wild_haricot_beans",
			() -> new BlockNamedItem(BlockInit.WILD_HARICOT_BEAN_CROP.get(), new Item.Properties().group(AlisBeanMod.BEAN_MOD_TAB)
					.food(FoodInit.HARICOT_BEANS)));
	
	public static final RegistryObject<Item> HARICOT_BEANS = ITEMS.register("haricot_beans",
			() -> new BlockNamedItem(BlockInit.HARICOT_BEAN_CROP.get(), new Item.Properties().group(AlisBeanMod.BEAN_MOD_TAB)
					.food(FoodInit.HARICOT_BEANS)));
	
	public static final RegistryObject<SoupItem> BOWL_OF_BAKED_BEANS = ITEMS.register("bowl_of_baked_beans",
			() -> new SoupItem(new Item.Properties().group(AlisBeanMod.BEAN_MOD_TAB).food(FoodInit.BOWL_OF_BAKED_BEANS)
	...
	public static final RegistryObject<CannedFoodItem> CAN_OF_BAKED_BEANS = ITEMS.register("can_of_baked_beans",
			() -> new CannedFoodItem(new Item.Properties().group(AlisBeanMod.BEAN_MOD_TAB).food(FoodInit.CAN_OF_BAKED_BEANS)
					.maxStackSize(1).containerItem(ItemInit.TIN_CAN.get())));
	
	// Seeds
	public static final RegistryObject<Item> TOMATO_SEEDS = ITEMS.register("tomato_seeds",
			() -> new BlockNamedItem(BlockInit.TOMATO_CROP.get(), new Item.Properties().group(AlisBeanMod.BEAN_MOD_TAB)));
	
	public static final RegistryObject<Item> CORN_SEEDS = ITEMS.register("corn_seeds",
			() -> new BlockNamedItem(BlockInit.CORN_CROP.get(), new Item.Properties().group(AlisBeanMod.BEAN_MOD_TAB)));
